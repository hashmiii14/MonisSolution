...
export const TEAM = [
  ...
  {
    name: "Ananya Verma",
    role: "Lighting & Smart Living Lead",
    experience: "10 years",
    image: "https://images.pexels.com/photos/8469992/pexels-photo-8469992.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=900&w=701",
    skills: ["Lighting Scenes", "Automation", "Atmosphere"],
    bio: "Ananya designs intelligent illumination schemes that transform spaces seamlessly from morning work to evening repose.",
  },
  {
    name: "Vikram Mehta",
    ...
    skills: ["Material Sourcing", "Artisan Network", "Quality Control"],
    bio: "Vikram orchestrates our network of master craftsmen, sourcing rare stone slabs and commissioning bespoke furnishings.",
  },
  {
    name: "Sameer Khan",
    ...
    skills: ["Site Execution", "Trade Coordination", "Quality Handover"],
    bio: "Sameer oversees on-site execution with precision, ensuring timelines, craftsmanship, and budgets remain uncompromised.",
  },
  {
    name: "Sofia Reyes",
    ...
    skills: ["3D Rendering", "Photoreal CGI", "Walkthroughs"],
    bio: "Sofia brings unbuilt concepts to life with cinema-grade realism so clients can experience their space prior to construction.",
  },
  {
    name: "Aryan Sen",
    ...
    experience: "8 years",
    image: "https://images.pexels.com/photos/6615203/pexels-photo-6615203.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=900&w=702",
    skills: ["Eco Finishes", "Thermal Comfort", "Local Sourcing"],
    bio: "Aryan ensures every project embraces conscious luxury, sourcing sustainable materials with genuine provenance.",
  },
];
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "You can reach out through our contact form or chat with us directly on WhatsApp (+91 98765 43210). We will schedule a complimentary discovery consultation to discuss your space.",
  },
  {
